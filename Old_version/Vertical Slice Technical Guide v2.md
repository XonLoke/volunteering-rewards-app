# Vertical Slice Technical Guide v2
...
│   │       └── theme.ts
│   └── web_portals/                  # React + Vite — Grace & Nurain
│       └── src/
│           ├── pages/
│           │   ├── admin/            # Nurain's admin pages
│           │   ├── organiser/        # Nurain's organiser pages
│           │   ├── merchant/         # Grace's merchant pages
│           │   └── scan/             # Vivian's scan pages
│           └── services/
...
| Web login screens | `frontend/web_portals/src/pages/...` | ✅ Built (check) |
| CI/CD pipeline | `.github/workflows/` | ⏳ To do |
...
- `web_portals/src/pages/scan/*` → QR scanner app (4 screens)
...
**Frontend pages to connect (web):**
- `web_portals/src/pages/admin/*` → 11 admin pages
- `web_portals/src/pages/organiser/*` → 8 organiser pages
