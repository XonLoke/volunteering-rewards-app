    ...
    const loadLatestPoints = async () => {
      try {
        ...
        if (storedUser) {
          ...
          setCurrentPoints(Number(user.points ?? coupon.userPoints ?? 0));
          return;
        }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View
          style={[styles.dividerRow, { backgroundColor: theme.colors.surface }]}
        >
          <View
            style={[
              styles.notchLeft,
        ...
        <View
          style={[styles.ticketBottom, { backgroundColor: theme.colors.surface }]}
        >
          ...
          <View style={styles.validRow}>
            <Text
              style={[styles.validLabel, { color: theme.colors.textSecondary }]}
            >
              Valid until
            </Text>
            <Text style={[styles.validDate, { color: theme.colors.text }]}>
              {coupon.validUntil}
            </Text>
          </View>
          ...
          <View style={styles.qrSection}>
            <Text
              style={[styles.qrLabel, { color: theme.colors.textSecondary }]}
            >
              Coupon Preview
            </Text>
            ...
            <View
              style={[
                styles.qrBox,
                { backgroundColor: "#fff", borderColor: theme.colors.border },
              ]}
            >
          ...
          >
            <View style={styles.pointsItem}>
              ...
              <Text style={[styles.pointsItemValue, { color: coupon.color }]}>
      ...
      >
        ...
        >
          <Text style={styles.redeemBtnText}>
            {canRedeem
              ? `REDEEM FOR ${coupon.pointsCost} POINTS`
              : "NOT ENOUGH POINTS"}
          </Text>
        </TouchableOpacity>
      </View>
