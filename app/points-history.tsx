          ...
          <View style={styles.totalTop}>
            <View>
              ...
              <Text style={styles.totalCaption}>
                Points available for rewards redemption
              </Text>
            </View>
        ...
        {loading ? (
          ...
          >
            ...
            <Text style={[styles.emptyText, { color: theme.colors.textSecondary }]}>
              Complete volunteer events to earn points, then redeem them for
              rewards.
            </Text>
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.historyText}>
                    <Text
                      style={[styles.historyLabel, { color: theme.colors.text }]}
                      numberOfLines={1}
                    >
                      {item.title}
                    </Text>
                  ...
                  <View
                    style={[styles.pointsPill, { backgroundColor: color + "14" }]}
                  >
                    <Text style={[styles.historyPoints, { color }]}>
                      {isEarn ? "+" : "-"}
                      {Math.abs(Number(item.points || 0)).toLocaleString()}
                    </Text>
