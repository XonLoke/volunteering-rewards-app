...
const NAV_ITEMS = [
  ...
  },
  {
    section: 'Event Tools',
    children: [
      { label: 'Roster', path: '/organiser/roster/:id', icon: 'R' },
      { label: 'Feedback', path: '/organiser/feedback/:id', icon: 'F' },
      { label: 'Q&A', path: '/organiser/qna/:id', icon: 'Q' },
      { label: 'Onsite Controller', path: '/organiser/onsite-controller/:id', icon: 'O' },
    ],
  },
];
