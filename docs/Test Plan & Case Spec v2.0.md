...
|-------------|-------------|----------|
| Test Plan (this document) | Strategy, automation, all test cases, results log | `docs/Test Plan & Case Spec v2.0.md` |
...
| P2 | 34 integration tests | Inline scripts | `curl` + `node` | ⬜ |
| P3 | 5 regression tests | Inline scripts | `curl` | ⬜ |
| P4 | 6 system tests | Inline scripts | Multi-step API | ⬜ |
| P5 | 12 security tests | Inline scripts | `curl` | ⬜ |
| P6 | 8 performance tests | Autocannon | `autocannon` | ✅ Partial |
| P7 | 8 UAT tests | N/A (manual) | Human | ⬜ |
...
opencode run "Execute Phase 1 from docs/Test Plan & Case Spec v2.0.md"

# Phase 2–6: Run integration, regression, system, security, performance
opencode run "Execute Phases 2-6 from docs/Test Plan & Case Spec v2.0.md"
```
...
*End of Test Plan & Case Specification v2.0 — OpenCode Automation Edition*
