# Native APK Build — Troubleshooting & Solution Report

**Project:** Volunteer Rewards App  
**Date:** 29 June 2026  
**Author:** Claude Code (assisting developer)  
**Status:** ✅ Solved — SDK upgraded, workflow cleaned, APK build ready to test
...
### 5.2 What Still Needs Proving

The actual `./gradlew assembleDebug` build on GitHub Actions. This requires pushing to the branch and triggering the workflow — something that was impossible under SDK 52.

---

## 6. How to Build the APK Now

### 6.1 Prerequisites

- Push committed changes to the `upgrade/expo-sdk-54-20260629` branch (already done)
...
### 6.3 Alternative: Manual Android Studio Build

If CI is unavailable:
1. Install Android Studio on macOS/Linux
2. Open `frontend/mobile_app/android/`
