Write unit tests for the feedback service.

## Project Context
- **Backend path:** D:\c3000c\volunteering-rewards-app\backend
- **Service to test:** src/services/feedback.service.js
- **Output path:** tests/unit/feedback.service.test.js
- **Test runner:** Node.js native (`node:test`, `node:assert`)
- **Module system:** CommonJS

Before writing tests, READ the service file first:
```
cat src/services/feedback.service.js
```
...
Cover: CRUD operations, success paths, error paths (404, validation).
